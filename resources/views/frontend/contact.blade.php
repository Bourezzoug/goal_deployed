        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div class="mb-12 max-w-[570px] lg:mb-0">
            ...
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full">
                <h4 class="text-black mb-1 text-xl font-bold">Address</h4>
                <p class="text-body-color text-base">
                    1, Angle rue Socrate et Abou Taour 1er étage. Maarif Ext
                </p>
              </div>
            </div>
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full">
                ...
                <p class="text-body-color text-base">+212 684 101 010</p>
              </div>
            </div>
            <div class="mb-8 flex w-full max-w-[370px]">
              <div
              ...
              <div class="w-full">
                ...
                <p class="text-body-color text-base">info@wibday.com</p>
              </div>
            </div>
          </div>
        </div>
